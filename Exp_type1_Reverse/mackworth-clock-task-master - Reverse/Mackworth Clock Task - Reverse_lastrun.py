...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\kcgad\\OneDrive\\Documents\\PsychoPy\\mackworth-clock-task-master\\Mackworth Clock Task - Reverse_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    music = sound.Sound("SBP_Mujic_180.wav")
    ...
    music1 = sound.Sound("SBP_Mujic_110.wav")
    ...
    trials_high = data.TrialHandler(nReps=1, method='sequential', 
    ...
    for thisTrials_high in trials_high:
        ...
        if trials_high.thisN == 0:
            music.play();
        # keep track of which components have finished
        TrialComponents = [clock, fixation, response_high, text]
    ...
    # completed 1 repeats of 'trials_high'
    ...
    # set up handler to look after randomisation of conditions etc
    trials_low = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
    ...
    for thisTrials_low in trials_low:
        ...
        if trials_low.thisN == 0:
            music1.play();
        # keep track of which components have finished
        Trial_2Components = [clock_2, fixation_2, response_low, text_2]
